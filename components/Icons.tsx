...
export const AspectRatioSquareIcon: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" className={className}>
...
export const BrushIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M9.06 11.9 2 22h5.33l4.8-4.8" />
    <path d="M14.2 2.2a2.4 2.4 0 1 1 3.4 3.4L8.2 14" />
    <path d="m14 6 6 6" />
    <path d="M18.8 10.2 21 8l-1.8-1.8" />
  </svg>
);
